...
<body class="VbBodyUser">
  ...
  $firstname = showMemberDetails($MemberInfo, 'firstname');
  $picture = showMemberDetails($MemberInfo, 'picture');
  $age = showMemberDetails($MemberInfo, 'age');
  $gender = showMemberDetails($MemberInfo, 'gender');
  $mail = showMemberDetails($MemberInfo, 'mail');
  $zipcode = showMemberDetails($MemberInfo, 'zipcode');
  $description = showMemberDetails($MemberInfo, 'description');
  //var_dump($picture);
